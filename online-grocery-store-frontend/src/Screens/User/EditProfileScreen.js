...
const EditProfileScreen = (props) => {
    ...
    const onEditUser = () => {        
        ...
        if(firstName_o.length>1 && password_o.length>1)
            dispatch(editUser(id,firstName_o,lastName_o,email,password_o,role,phoneNumber))
    }
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="mb-3">
                                ...
                                <input defaultValue={phoneNumber} onChange={(e)=>{setPhoneNumber(e.target.value)}} type="text" className="form-control"  placeholder="Phone "></input>
                            </div>

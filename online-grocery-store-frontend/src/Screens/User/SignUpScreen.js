...
const SignUpScreen = (props) => {
    ...
    const onSignUp = () => {
        ...
        setPasswordError("Password is required")
            ...
            setPhoneNumberError("Phone number is required is required")
        else
            setPhoneNumberError("")


        if(firstName.length>1 && password.length>1 && email.match("^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+$") && ((role==="CUSTOMER" && !userSignIn.response)) && phoneNumber.length>1)
            dispatch(signup(firstName,lastName,email,password,phoneNumber,role))
    }
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="mb-3">
                                ...
                                <input required onChange={(e)=>{setPhoneNumber(e.target.value)}} type="text" className="form-control" ></input>
                                <h6 className="text-danger text-center">{phoneNumberError}</h6>
                            </div>
